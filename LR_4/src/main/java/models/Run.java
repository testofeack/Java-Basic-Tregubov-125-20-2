...
public class Run {
    ...
    public void createTypicalUniversity() {
        ...
        System.out.println("- " + group1.getName() + ", количество студентов: " + group1.getSize());
        System.out.println("- " + group2.getName() + ", количество студентов: " + group2.getSize());
        System.out.println("- " + group3.getName() + ", количество студентов: " + group3.getSize());
